			  	...
			  	<form action="#" method="post">
					...
					<div class="itemrow">
				  	...
				  	<div class="itemrow">
				  			...
				  			<div style="width: 80%; float: left;">
				  				<?php echo '<input type="text" name="location" value="'.$f_loca.'" placeholder="e.g: 1st Lane,Piliyanda">'; ?>
				  			</div>
				  		</div>
					<div class="itemrow">
				  			<div style="width: 20%; float: left;">
							...
							<div style="width: 80%; float: left;">
							  ...
							  <option value="None">None</option>
							  <option value="Southeast University">University of Kelaniya</option>
							  <option value="Brac University">University of Colombo</option>
							  <option value="Dhaka Univesity">Univesity of Moratuwa</option>
							</select>
							</div>
						</div>
					<div class="itemrow">
